...
impl ConstantPulse {
    pub const fn new(amplitude: f64, frequency: f64, phase: f64, length: f64) -> ConstantPulse {
        return ConstantPulse { amplitude: amplitude, frequency: frequency, phase: phase, length: length }
    }
}
